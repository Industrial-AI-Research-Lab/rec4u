...
def dependency_adj_matrix(text, nlp):
...
def process(filename, nlp):
    ...
    for i in range(0, len(lines), 3):
        ...
        adj_matrix = dependency_adj_matrix(text_left+' '+aspect+' '+text_right, nlp)
...
if __name__ == '__main__':
    ...
    opt.lang = languages[opt.lang]

    nlp = load_spacy(opt.lang)
    process(opt.dataset, nlp)
